...
namespace iTextSharp.text.pdf
{
  ...
  public class PdfContentByte
  {
    ...
    */
    ...
    {
      this.Circle((float)x, (float)y, (float)r);
    }
    ...
    {
      this.Rectangle((float)x, (float)y, (float)w, (float)h);
    }
    ...
    */
    ...
    {
      this.Arc((float)x1, (float)y1, (float)x2, (float)y2, (float)startAng, (float)extent);
    }
